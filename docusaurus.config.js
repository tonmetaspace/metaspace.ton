...
<style>
    ...
    .Headline--l-2.Headline--t-developer {
        font-size: 28px;
        font-weight: 700;
        line-height: 36px
    }
    ...
    .Badge__inner {
        ...
        color: var(--text_light_secondary);
        border: 1px solid var(--text_light_secondary);
        border-radius: 8px
    }
    ...
    .Container.size--small .Container__inner {
        max-width: calc(100% - 32px);
        min-width: calc(100% - 32px)
    }
    ...
    @media(min-width:734px) {
        .Container.size--small .Container__inner {
            max-width: calc(100% - 80px - 64px - (100% - 80px - 176px)/12*4);
            min-width: calc(100% - 80px - 64px - (100% - 80px - 176px)/12*4)
        }
    }
    ...
    @media(max-width:1279px) {
        .HideByMediaBlock {
            display: var(--xlVisible)
        }
    }

    @media(max-width:1023px) {
        .HideByMediaBlock {
            display: var(--lVisible)
        }
    }

    @media(max-width:833px) {
        .HideByMediaBlock {
            display: var(--mVisible)
        }
    }

    @media(max-width:733px) {
        .HideByMediaBlock {
            display: var(--sVisible)
        }
    }

    @media(max-width:568px) {
        .HideByMediaBlock {
            display: var(--preSVisible)
        }
    }

    @media(max-width:413px) {
        .HideByMediaBlock {
            display: var(--xsVisible)
        }
    }
    ...
    .tooltipItem__inner--default {
        padding: 12px;
        background: var(--modal_tooltip);
        box-shadow: 0 0 2px rgba(0, 0, 0, .08), 0 2px 24px rgba(0, 0, 0, .08)
    }

    .tooltipItem.showArrow .tooltipItem__inner--comics:after {
        content: ""
    }

    .tooltipItem__inner--comics {
        padding: 16px;
        max-width: 400px;
        border-radius: 16px;
        background: var(--default_white);
        box-shadow: 0 4px 24px rgba(0, 0, 0, .08);
        border: 1px solid rgba(114, 138, 150, .12);
        box-sizing: border-box
    }
    ...
    .tooltipItem__inner--comics:after {
        position: absolute;
        left: calc(100% - 7px);
        top: calc(var(--comics-height)/2 - 6px);
        transform: rotate(45deg);
        background: #fff;
        border-color: rgba(114, 138, 150, .12) rgba(114, 138, 150, .12) #fff #fff;
        border-style: solid;
        border-width: 1px;
        height: 12px;
        width: 12px;
    ...
    .tooltipItem--hor-right-after .tooltipItem__inner--comics:after {
        left: -7px;
        border-color: #fff #fff rgba(114, 138, 150, .12) rgba(114, 138, 150, .12);
        border-style: solid;
        border-width: 1px;
        border-radius: 0 0 0 2px
    }

    .tooltipItem--hor-center.tooltipItem--ver-top .tooltipItem__inner--comics:after {
        left: 50%;
        top: calc(100% - 7px);
        border-color: #fff rgba(114, 138, 150, .12) rgba(114, 138, 150, .12) #fff;
        border-style: solid;
        border-width: 1px;
    ...
    @font-face {
        ...
        font-weight: 800;
        font-display: block;
        src: url(/_next/static/media/Mulish-ExtraBold.49add491.woff2) format("woff2")
    }
    ...
    @font-face {
        ...
        font-weight: 700;
        font-display: block;
        src: url(/_next/static/media/Mulish-Bold.50defa2a.woff2) format("woff2")
    }
    ...
    @font-face {
        ...
        font-weight: 500;
        font-display: block;
        src: url(/_next/static/media/Mulish-Medium.36e04c25.woff2) format("woff2")
    }
    ...
    @font-face {
        ...
        font-weight: 400;
        font-display: block;
        src: url(/_next/static/media/Mulish-Regular.f4910cec.woff2) format("woff2")
    }
    ...
    @font-face {
        ...
        font-weight: 700;
        font-display: block;
        src: url(/_next/static/media/IBMPlexMono-Bold.d6705808.woff2) format("woff2")
    }
    ...
    @font-face {
        ...
        font-weight: 400;
        font-display: block;
        src: url(/_next/static/media/IBMPlexMono-Regular.9d49d570.woff2) format("woff2")
    }
    ...
    body[data-theme=light] {
        ...
        --background_loading_gradient_light: linear-gradient(90deg, #f7f9fb -9.69%, #f2f5f8 -9.68%, #fff 52.19%, #f2f5f8 106.56%);
